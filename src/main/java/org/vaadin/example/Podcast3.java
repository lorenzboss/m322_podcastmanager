...
@Route("/podcast3")
@PageTitle("Podcast3")
public class Podcast3 extends VerticalLayout {
    ...
    public Podcast3() {
        ...
        H1 mainHeader = new H1("Gemischtes Hack");
        ...
        Image cover = new Image("/images/3/cover.jpeg", "");
        ...
        Paragraph descriptionText = new Paragraph("Gemischtes Hack ist ein wöchentlicher Podcast, der von Felix Lobrecht (Comedian und Autor) und Tommi Schmitt (TV-Moderator und Kolumnist) moderiert wird. In jeder Folge sprechen die beiden über aktuelle Themen in der Gesellschaft, ihre Erfahrungen in ihrem spannenden Berufsalltag, etc. Zudem bringen sie lustige Witze in das Gespräch ein. Der Podcast ist exklusiv auf Spotify verfügbar und wird jeden Mittwoch veröffentlicht.");
        ...
        Image artist1Image = new Image("/images/3/artist1.jpeg", "");
        artist1Image.addClassName("artistImage");

        Paragraph artist1Name = new Paragraph("Felix Lobrecht");
        artist1Name.addClassName("artistName");

        Image artist2Image = new Image("/images/3/artist2.jpeg", "");
        artist2Image.addClassName("artistImage");

        Paragraph artist2Name = new Paragraph("Tommi Schmitt");
